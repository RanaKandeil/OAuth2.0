...
from models import Base, CatalogItem, Category, User
...
#read Catalog Item
@app.route('/category/<int:category_id>/item/<int:catalog_item_id>')
def showCatalogItem(category_id, catalog_item_id):
    print("showCatalogItem")
...
@app.route('/category/<int:category_id>/item/<int:catalog_item_id>/edit', methods=['GET', 'POST'])    
@login_required
...
#Delete Catalog Item
@app.route('/category/<int:category_id>/item/<int:catalog_item_id>/delete', methods=['GET', 'POST'])    
@login_required
...
def editCategory(category_id):
    ...
    if request.method == 'POST':
        if request.form['name']:
            ...
            flash(
                'Category Successfully Edited %s' % category.name)
            return redirect(url_for('showCatalog'))
    else:
...
def deleteCategory(category_id):
    ...
    if request.method == 'POST':
        ...
        session.commit()
        flash('Category %s is deleted Successfully ' % category.name )
        return redirect(url_for('showCatalog'))
    else:
